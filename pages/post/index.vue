      ...
      <div class="tab"
        ...
        <div class="left">
          <el-row type='flex'
                  ...
                  :key="index">
            <span @mouseenter="handleEnter(index)"
        ...
        <div class="right"
             v-if="current!==false">
          <ul>
            <li v-for="(item,index) in navs[current].children"
                :key="index">
              {{index+1}}&nbsp;&nbsp;
              <!-- <Nuxt-link to='#'>{{item.city}}&nbsp;&nbsp;{{item.desc}}</Nuxt-link> -->
              <a href="Javascript:;"
                 @click="getpostlist(item.city)">{{item.city}}&nbsp;&nbsp;{{item.desc}}</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="header">
        ...
        <el-row type='flex'
          ...
          <el-button type='primary'
                     @click="$router.push({path:'post/create'})"><i class="el-icon-edit"></i>写游记</el-button>
        </el-row>
        <hr>
      </div>
      <div class="post">
